...
const renderAllGalleries = (filteredWorks = null) => { // Si aucune prop, on affiche tout
...
const setupFilters = (categories) => {
  ...
  const createBtn = (id, name, active = false) => {
    ...
    btn.addEventListener("click", () => {
      ...
      const filtered =
        id === "all" ? allWorks : allWorks.filter((work) => work.categoryId === id);
